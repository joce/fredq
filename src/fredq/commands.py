...
class CommandSpec:
    ...
    # Non-None: command lives under a nested subcommand group (e.g. "series").
...
# incrementally. See AGENTS.md "Architecture".
...
COMMANDS: Final[tuple[CommandSpec, ...]] = _CORE_COMMANDS
